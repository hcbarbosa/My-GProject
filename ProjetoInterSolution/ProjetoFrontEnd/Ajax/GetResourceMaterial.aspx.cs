...
{
    public partial class GetResourceMaterial : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.Params["id"] != null)
            {
                if (Request.Params["acao"] != null && Request.Params["acao"] == "edit")
                {
                    ...
                    string teste = re.valor.ToString().Replace(',', '.');
                    Response.Write("[{\"descricao\":\"" + re.descricao + "\",\"tipo\":\"" + re.Tipo.descricao + "\",\"unidade\":\"" + re.qtd_unid_disponivel + "\", \"valor\":\"" + re.valor + "\"}]");
                }                
